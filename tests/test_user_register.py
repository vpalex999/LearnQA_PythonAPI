...
class TestUserRegister(BaseCase):
    ...
    def test_create_user_with_existing_email(self):
        ...
        with allure.step("Create user with exist email"):
    ...
    def test_create_user_validation_field(self, case_field_value, expected):
        """This test does validating boundaries of fields of data for create user"""
        ...
        with allure.step("Try create user"):
    ...
    def test_create_user_without_any_field(self, name_field,
        ...
        with allure.step("Prepare data and delete field from"):
            data = self.prepare_registration_data()
            del data[name_field]
